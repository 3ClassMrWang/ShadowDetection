...
int main() {
	...
	cv::Mat frame = cv::imread("dataset/samples/frame.bmp");
	cv::Mat bg = cv::imread("dataset/samples/bg.bmp");
	cv::Mat fg = cv::imread("dataset/samples/fg.bmp", CV_LOAD_IMAGE_GRAYSCALE);
